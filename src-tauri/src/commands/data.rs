...
use crate::repo::reports::{self, AppUsage, DaySummary, HourSlot};
...
pub async fn get_week_days(
    ...
    reports::week_days(&pool, week_offset)
        .await
        .map_err(Into::into)
}
...
pub async fn get_week_apps(
    ...
    reports::week_apps(&pool, week_offset, limit.unwrap_or(10))
        .await
        .map_err(Into::into)
}
...
pub async fn get_month_days(
    ...
    reports::month_days(&pool, month_offset)
        .await
        .map_err(Into::into)
}
...
pub async fn get_month_apps(
    ...
    reports::month_apps(&pool, month_offset, limit.unwrap_or(10))
        .await
        .map_err(Into::into)
}
